...
<!-- Title -->
@section('title', 'Newsbox -> Technology')
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="single-blog-post style-2 mb-5">
                                                ...
                                                <div class="blog-thumbnail">
                                                    ...
                                                    <span style="font-weight: 600; color: blue;" class="post-date">Technology</span>
                                                </div>
...
@section('script')
    <script>
        $(document).ready(function(){
            $("#technologypage").addClass('activePage');
        });
    </script>
@endsection